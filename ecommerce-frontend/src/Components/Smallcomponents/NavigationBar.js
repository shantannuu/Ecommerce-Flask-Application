        ...
        { user ?  (
          <>
            ...
            <Menu
              ...
              className={classes.cartMenu}
            >
              <MenuItem onClick={handleMenuClose} className={classes.subMenuItem}>{ user.username }</MenuItem>
...
<IconButton
            ...
            <Menu
              ...
              className={classes.cartMenu}
            >
              <MenuItem onClick={handleMenuClose} className={classes.subMenuItem}>Registeration</MenuItem>
              <MenuItem onClick={handleMenuClose} className={classes.subMenuItem}>Login</MenuItem>
            </Menu>
          </>
        )}
      </Toolbar>
